...
RPSChoice makeRPSChoice(){
  ...
  */
  ...
  int RandomNum;                      // initialize the random variable needed to select the strategy

  if (roundsPlayed < 1) {             // since some strategies rely on previous game knowledge, an if statement is used to make sure the code doesn't break
  ...
  switch (RandomNum) {
    ...
    case 1:
      ...
      randRPS;                          // selects a random output 

      break;

    case 2: 

      choice = RPS_Paper;             // selects paper 
    
      break;

    case 3:

      if (roundResults[roundsPlayed-1] = Round_Won) {        // selects the previous winning choice
    ...
    case 4: 
      ...
      if (roundResults[roundsPlayed-1] = Round_Lost) {                 // selects the previous losing choice 
    ...
    case 5:
      ...
      choice = arduinoChoices[roundsPlayed-1];                    // selects the previous output 
 
      break;
  }

  return choice;                      // overall this strategy should be random and unpredictable changing the game from strategy based to luck. There is a slight bias to 
                                      // paper, however this was planned as paper is our favourite RPS choice.
}
